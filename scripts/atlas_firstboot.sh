...
signage ALL=(ALL) NOPASSWD: /usr/bin/tee *
signage ALL=(ALL) NOPASSWD: /usr/bin/systemctl stop ods-setup-ap
signage ALL=(ALL) NOPASSWD: /usr/bin/systemctl start ods-setup-ap
signage ALL=(ALL) NOPASSWD: /usr/sbin/dhclient *
signage ALL=(ALL) NOPASSWD: /usr/bin/dhclient *
